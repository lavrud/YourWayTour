 function (t, e) {
     ...
     function n(e, i) {
         ...
         for (var r in a) i.test(r) && (s[r.replace(n, function (t, e) {
     ...
     d.prototype = {
         ...
         place: function () {
             if (!this.isInline) {
                 ...
                 "auto" === g && (p = -n + o.top - i, f = n + s - (o.top + d + i), g = Math.max(p, f) === f ? "top" : "bottom"), this.picker.addClass("datepicker-orient-" + g), "top" === g ? u += d : u -= i + parseInt(this.picker.css("padding-top")), this.picker.css({
                     top: u,
                     left: c,
                     zIndex: r
                 })
         ...
         fill: function () {
             var e, a = new Date(this.viewDate),
                 s = a.getUTCFullYear(),
                 n = a.getUTCMonth(),
                 ...
                 l = f[this.o.language].today || f.en.today || "",
                 c = f[this.o.language].clear || f.en.clear || "";
             ...
             var u = i(s, n - 1, 28),
                 p = g.getDaysInMonth(u.getUTCFullYear(), u.getUTCMonth());
     ...
     t.fn.datepicker = function (e) {
         ...
         return this.each(function () {
             ...
             if (!h) {
                 var c = n(this, "date"),
                     p = r(t.extend({}, u, c, o).language),
                     f = t.extend({}, u, p, c, o);
                 if (s.is(".input-daterange") || f.inputs) {
                     var g = {
                         inputs: f.inputs || s.find('input[name="start"], input[name="end"]').toArray()
                     };
                     s.data("datepicker", h = new l(this, t.extend(f, g)))
                 } else s.data("datepicker", h = new d(this, f))
             }
             if ("string" == typeof e && "function" == typeof h[e] && void 0 !== (a = h[e].apply(h, i))) return !1
         }), void 0 !== a ? a : this
     }, "true" == is_rtl ? is_rtl = !0 : is_rtl = !1;
     ...
     var f = t.fn.datepicker.dates = {
         ...
         g = {
             ...
             parseDate: function (e, a, s) {
                 function n() {
                     var t = this.slice(0, c[o].length);
                     return t === c[o].slice(0, t.length)
                 }
                 if (e) {
                     ...
                     if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(e)) {
                         for (e = new Date, o = 0; o < c.length; o++) switch (r = l.exec(c[o]), h = parseInt(r[1]), r[2]) {
                             case "d":
                                 e.setUTCDate(e.getUTCDate() + h);
                                 break;
                             case "m":
                                 e = d.prototype.moveMonth.call(d.prototype, e, h);
                                 break;
                             case "w":
                                 e.setUTCDate(e.getUTCDate() + 7 * h);
                                 break;
                             case "y":
                                 e = d.prototype.moveYear.call(d.prototype, e, h)
                         }
                     ...
                     if (c.length !== y.length && (y = t(y).filter(function (e, i) {
                         ...
                         var w;
                         for (o = 0, w = y.length; o < w; o++) {
                             if (u = parseInt(c[o], 10), r = y[o], isNaN(u)) switch (r) {
                                 case "MM":
                                     p = t(f[s].months).filter(n), u = t.inArray(p[0], f[s].months) + 1;
                                     break;
                                 case "M":
                                     p = t(f[s].monthsShort).filter(n), u = t.inArray(p[0], f[s].monthsShort) + 1
                             }
                             v[r] = u
                         }
                         var k, _;
                         for (o = 0; o < D.length; o++)(_ = D[o]) in v && !isNaN(v[_]) && (k = new Date(e), m[_](k, v[_]), isNaN(k) || (e = k))
                     }
                     return e
                 }
             },
